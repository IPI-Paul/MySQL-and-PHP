...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Example 5-148</title>
	</head>
	<body>
		<p>
		<h1>mysql_xdevapi\SqlStatementResult::hasData example</h1>
		<h2></h2>
		<hr />
		<div name="retStr">
			<?php 
				...
				$cols = $session->sql("select * from dbtest.workers")->execute()->hasData();
				
				print_r(($cols  == 1) ? "Has data!" : "Does not have data!");
