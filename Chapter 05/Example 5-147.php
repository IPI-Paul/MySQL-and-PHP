...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Example 5-147</title>
	</head>
	<body>
		<p>
		<h1>mysql_xdevapi\SqlStatementResult::getWarningsCount example</h1>
		<h2></h2>
		<hr />
		<div name="retStr">
			<?php 
				...
				try {
					$cols = $session->sql("select *, age + '/' as [ErrorCol] from dbtest.workers")->execute()->getWarningsCount();
				} catch(Exception $e) {
					$cols = $e;
				}
				print_r($cols);
