...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Example 5-142</title>
	</head>
	<body>
		<p>
		<h1>mysql_xdevapi\SqlStatementResult::getColumnNames example</h1>
		<h2></h2>
		<hr />
		<div name="retStr">
			<?php 
				...
				$cols = $session->sql("select * from dbtest.workers")->execute()->getColumnNames();
